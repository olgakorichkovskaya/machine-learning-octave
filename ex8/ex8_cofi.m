...
%  included set of weights that we trained on that
...
% a new user just observed. to put in your own ratings for the
...
% recommendations by computing the predictions matrix.
%
